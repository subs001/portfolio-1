...
function Profile() {
  return (
    <div name="home" id="home">
      <div className="w-full flex justify-center pt-24 md:pt-16">
        <img
          src={profile_pic}
          alt="User"
      ...
      <p className="font-marckScript text-4xl md:text-5xl text-center my-8 mx-auto md:my-24 whitespace-nowrap w-[21ch] overflow-hidden line">
        Hi, I'm Shriya Rathor
      </p>
      <ul className="grid grid-rows-3 md:grid-cols-3 px-32 py-8 md:pt-8 gap-4 md:gap-4">
